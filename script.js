  ...
  try {
    ...
    uniqueProductSectionTypes.forEach(productSectionType => {
      ...
      rows.forEach((row, index) => {
        ...
        let productHtml = `
          <div class="showcase">
            <a onclick="insertNewClick('affiliate single 2')" href="${productAffiliateLink}" target="_blank" class="showcase-img-box">
              <img src="${productImage}" width="70" class="showcase-img">
            </a>
            <div class="showcase-content">
              <a onclick="insertNewClick('affiliate single 2')" href="${productAffiliateLink}" target="_blank">
                <h4 class="showcase-title">${productName}</h4>
              </a>
              <a onclick="insertNewClick('affiliate single 2')" href="${productAffiliateLink}" target="_blank" class="showcase-category">${productTypeName}</a>
              <div class="price-box">
